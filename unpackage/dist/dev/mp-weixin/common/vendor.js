...
var _auth = __webpack_require__(/*! @/utils/auth.js */ 17);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setXXToken: function setXXToken(state, xxtoken) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getToken = getToken;exports.setToken = setToken;exports.removeToken = removeToken;exports.getUserinfo = getUserinfo;exports.setUserinfo = setUserinfo;exports.removeUserinfo = removeUserinfo;function getToken() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _auth = __webpack_require__(/*! @/utils/auth.js */ 17);
...

{
  ...
  request: function request(url, data, method) {var _this = this;
    return new Promise(function (resolve, reject) {
      var token = { token: (0, _auth.getToken)() };
      data = _objectSpread({}, data, token);
      uni.request({
        url: _this.config.base + url,
        method: method,
        data: data,
        header: {
  ...
  uploadfile: function uploadfile(url, data, tempFile) {var _this2 = this;

    return new Promise(function (resolve, reject) {
      var token = { token: (0, _auth.getToken)() },
      data = _objectSpread({}, data, token);
      uni.uploadFile({
        url: _this2.config.base + url,
        filePath: tempFile,
        name: 'file',
        formData: data,
